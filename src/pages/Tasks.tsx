      ...
      <div className="p-6">
        <div className="bg-red-50 border border-red-200 rounded-lg p-4">
          ...
          <p className="text-red-600 text-sm mt-2">
            This error typically means Firestore security rules need to be deployed.
            <br />
            Run: <code className="bg-red-100 px-2 py-1 rounded">firebase deploy --only firestore:rules</code>
          </p>
        </div>
      </div>
    );
